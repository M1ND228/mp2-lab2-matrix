...
TVector<ValType>::TVector(int s, int si)
{
    ...
    {
        throw std::logic_error("Input error: invalide value of vector length in constructor");
    }
    Size = s;
    StartIndex = si;
...
ValType& TVector<ValType>::operator[](int pos)
{
    ...
    else { throw std::out_of_range("Input error: invalide value of vector length in override []"); }
}
